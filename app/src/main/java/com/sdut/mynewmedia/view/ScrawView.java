...
public class ScrawView extends View {
    ...
    public void saveBitmap(Context context) throws Exception {
        ...
        LogUtil.d("Scraw",appDir.getPath()+"999");
        ...
        LogUtil.d("Scraw",file.getPath()+"888");
        file.createNewFile();
        LogUtil.d("Scraw",file.getPath()+"777");
        FileOutputStream fileOutputStream = new FileOutputStream(file);
        LogUtil.d("Scraw",fileOutputStream.toString()+"666");
        //以100%的品质创建png图片
        new Thread(new Runnable() {
            @Override
            public void run() {
                mm = mBitmap.compress(Bitmap.CompressFormat.PNG, 100, fileOutputStream);
            }
        }).start();
        if (mm){
