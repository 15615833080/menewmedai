...
import com.sdut.mynewmedia.adapter.MyFragmentPagerAdapter;
import com.sdut.mynewmedia.fragment.CountFragment;
import com.sdut.mynewmedia.fragment.HomeFragment;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                Toast.makeText(MainActivity.this, "再按一次退出MyNewMedia",
